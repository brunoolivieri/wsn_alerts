...
public class jClient implements MessageListener
{
	MoteIF mote;
...
//		System.out.println("Port connected!");
		mote.registerListener(new returnMsg(), this);
...
//		System.out.println(".");
		...
		if (msg instanceof returnMsg) {
			returnMsg omsg = (returnMsg)msg;
			waitFlag=false;
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		if ((args.length==3) && (Integer.decode(args[0])>0 && Integer.decode(args[1])>0 && (args[2].equals("T")||args[2].equals("P")))) {
			...
			System.out.println("Invalid argument>> java jClient <client id> <server id> <T|P> ");
		}

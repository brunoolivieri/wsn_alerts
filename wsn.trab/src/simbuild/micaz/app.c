...
#line 737
typedef int (*__compar_fn_t)(const void *arg_0x40332bc8, const void *arg_0x40332d60);
#line 771
__extension__ 
#line 788
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x404c6c78), 
int (*key_eq_fn)(void *arg_0x404c50e8, void *arg_0x404c5260));
#line 103
#line 102
int 
...
typedef TMilli alarmGroupC$Timer0$precision_tag;
...
static void alarmGroupC$Timer0$fired(void );
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void alarmGroupC$Boot$booted(void );
...
enum SimSchedulerBasicP$__nesc_unnamed4322 {
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void alarmGroupC$Timer0$startPeriodic(uint32_t dt);
# 23 "alarmGroupC.nc"
bool alarmGroupC$is_coord[1000];
int alarmGroupC$my_group[1000];
#line 24
int alarmGroupC$i[1000];
int alarmGroupC$looptime[1000];
bool alarmGroupC$active_childs[1000][9];



static inline void alarmGroupC$Boot$booted(void );
#line 55
static inline void alarmGroupC$Timer0$fired(void );
# 44 "/opt/tinyos-2.1.1/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$__nesc_unnamed4323 {
...
enum /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$__nesc_unnamed4324 {
#line 63
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4083a7f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4083a7f0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4083a158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4083a158, msg, payload, len);
#line 67
...
#line 67
# 224 "/opt/tinyos-2.1.1/tos/lib/tossim/TossimActiveMessageC.nc"
static inline am_addr_t TossimActiveMessageC$default$amAddress(void )
#line 224
{
  return 0;
...
#line 49
  __nesc_result = TossimActiveMessageC$default$amAddress();
#line 49
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x406921b8){
#line 64
  switch (arg_0x406921b8) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x406921b8);
#line 64
      break;
#line 64
    }
...
#line 55
{
  ...
  if (alarmGroupC$is_coord[sim_node()]) {
      sim_log_debug(111U, "basico", "COORDENADOR id %d, do grupo %d vivo e rodando.\n", TOS_NODE_ID, alarmGroupC$my_group[sim_node()]);
    }
  else 
#line 59
    {
      sim_log_debug(112U, "basico", "LEITOR id %d, do grupo %d vivo e rodando.\n", TOS_NODE_ID, alarmGroupC$my_group[sim_node()]);
    }
#line 61
  ;
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x409e03a8){
#line 72
  switch (arg_0x409e03a8) {
#line 72
    case 0U:
#line 72
      alarmGroupC$Timer0$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x409e03a8);
#line 72
      break;
#line 72
    }
...
#line 569
{
  sim_log_debug(139U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 537
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(138U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 473
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(135U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(136U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 291
  sim_log_debug(128U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 179
{
  sim_log_debug(118U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 186
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(123U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(124U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 217
  sim_log_debug(125U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 356
{
  sim_log_debug(130U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void alarmGroupC$Timer0$startPeriodic(uint32_t dt){
#line 53
...
#line 30
{
  ...
  alarmGroupC$my_group[sim_node()] = TOS_NODE_ID / 10;

  if (TOS_NODE_ID % 10 == 0) {
      alarmGroupC$is_coord[sim_node()] = TRUE;
      sim_log_debug(109U, "basico", "COORDENADOR id %d, é do grupo %d.\n", TOS_NODE_ID, alarmGroupC$my_group[sim_node()]);
    }
  else 
#line 37
    {
      alarmGroupC$is_coord[sim_node()] = FALSE;
      sim_log_debug(110U, "basico", "LEITOR id %d, é do grupo %d.\n", TOS_NODE_ID, alarmGroupC$my_group[sim_node()]);
    }
#line 40
  ;

  alarmGroupC$Timer0$startPeriodic(alarmGroupC$looptime[sim_node()]);

  for (alarmGroupC$i[sim_node()] = 1; alarmGroupC$i[sim_node()] < 10; alarmGroupC$i[sim_node()]++) {
      alarmGroupC$active_childs[sim_node()][alarmGroupC$i[sim_node()]] = FALSE;
    }
}
...
#line 277
  ...
  sim_log_debug(127U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 449
{
  sim_log_debug(133U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(113U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(114U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(115U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(116U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 455
{
  sim_log_debug(134U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 457
  {
...
#line 500
{
  ...
  sim_log_debug(137U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 223
{
  ...
  sim_log_debug(126U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module alarmGroupC */
  if (!strcmp(varname, "alarmGroupC$is_coord"))
  {
    *addr = (uintptr_t)&alarmGroupC$is_coord[__nesc_mote];
    *size = sizeof(alarmGroupC$is_coord[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "alarmGroupC$my_group"))
  {
    *addr = (uintptr_t)&alarmGroupC$my_group[__nesc_mote];
    *size = sizeof(alarmGroupC$my_group[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "alarmGroupC$i"))
  {
    *addr = (uintptr_t)&alarmGroupC$i[__nesc_mote];
    *size = sizeof(alarmGroupC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "alarmGroupC$looptime"))
  {
    *addr = (uintptr_t)&alarmGroupC$looptime[__nesc_mote];
    *size = sizeof(alarmGroupC$looptime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "alarmGroupC$active_childs"))
  {
    *addr = (uintptr_t)&alarmGroupC$active_childs[__nesc_mote];
    *size = sizeof(alarmGroupC$active_childs[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module alarmGroupC */
  alarmGroupC$is_coord[__nesc_mote] = FALSE;
  memset((void *)&alarmGroupC$my_group[__nesc_mote], 0, sizeof alarmGroupC$my_group[__nesc_mote]);
  alarmGroupC$i[__nesc_mote] = 0;
  alarmGroupC$looptime[__nesc_mote] = 100000;
  memset((void *)&alarmGroupC$active_childs[__nesc_mote], 0, sizeof alarmGroupC$active_childs[__nesc_mote]);
